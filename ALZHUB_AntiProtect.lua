...
-- Main Frame (KECIL, gak nutupin layar)
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "✅ Script loaded! Klik logo ALZ buat buka menu",
    Duration = 3
})